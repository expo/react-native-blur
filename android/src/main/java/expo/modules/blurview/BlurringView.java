 ...
 */
public class BlurringView extends View implements ModuleRegistryConsumer {
  ...
  private void checkForCircularReference() {
    ...
    if (circularReference) {
      ...
      body.putString("message", "BlurView must not be a child of the view that is being blurred.");
      mModuleRegistry.getModule(EventEmitter.class).emit("ReactNativeBlurError", body);
